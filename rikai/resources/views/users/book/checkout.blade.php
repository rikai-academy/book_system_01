                  ...
                  <div class="row">
                     <div class="col-md-6 form-it">
                        ...
                        <input type="text" name="name_of_card"
                           value="{{ old('name_of_card')?old('name_of_card'):$data->name_of_card }}">
                     </div>
                     <div class="col-md-6 form-it">
                        <label>{{__('message.Credit_card_number')}}</label>
                        <input type="password" name="credit_card_number"
                           value="{{ old('credit_card_number')?old('credit_card_number'):$data->credit_card_number }}">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-2">
