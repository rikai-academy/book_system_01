   ...
   <div class="login-content">
      ...
      <div class="row">
         ...
         <div class="social-btn-2">
            <a class="fb" href="{{ route('login.provider', 'facebook') }}"><i class="ion-social-facebook"></i>Facebook</a>
            <a class="tw" href="{{ route('login.provider', 'google') }}"><i class="ion-social-google"></i>Google</a>
         </div>
      </div>
   </div>
</div>
