...
<div class="movie-items">
   <div class="container">
      <div class="row ipad-width">
         <div class="col-md-8">
            <div class="title-hd">
               <h2>{{__('message.in_library')}}</h2>
               <a href="{{ route('book.index') }}" class="viewall">{{__('message.View_all')}} <i
                        ...
                        <div class="slick-multiItem">
                           ...
                           <div class="slide-it">
                              <div class="movie-item">
                                 ...
                                 <div class="hvr-inner">
                                    <a href="{{url('book/'.$book->id)}}"> {{__('message.Read_more')}} <i
                                          class="ion-android-arrow-dropright"></i> </a>
                                 </div>
                                 <div class="title-in">
                                    <h6><a href="{{url('book/'.$book->id)}}">{{$book->title}}</a></h6>
                                    <p><i class="ion-android-star"></i><span>{{$book->rate?$book->rate:0}}</span> /10
                                    </p>
                                 </div>
                              </div>
                           </div>
            ...
            <div class="title-hd">
               <h2>{{ __('message.'.$category->title)  }}</h2>
               <a href="{{ route('categoryuser.edit',[$category->id]) }}" class="viewall">{{__('message.View_all')}} <i
                     class="ion-ios-arrow-right"></i></a>
            </div>
            <div class="tabs">
            ...
            <div class="sidebar">
               ...
               <div class="celebrities">
                  ...
                  <div class="celeb-item">
                     <a href="{{ url('profile/'.$item->id) }}"><img src="{{ imgSrc($item->image) }}"
                           class="small-user-image" width="70" height="70"></a>
                  ...
                  @endforeach
                  <a href="{{ route('listuser') }}" class="btn">{{__('message.List_User')}}<i
                        class="ion-ios-arrow-right"></i></a>
               </div>
               <div class="celebrities">
